...
public class CommInf implements Domain{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final CommInf other = (CommInf) obj;
		if (commState == null) {
