 ...
 */
@Entity
@Table(name = "MOBILE_SIGN_TER_REG")
public class SignTerReg implements Domain{	

	/**
	 * 
	 */
	private static final long serialVersionUID = -5071981837310816010L;
	...
	@Column(name = "SIGN_TER_NO")
	private String signTerNo;//签约/解约编号
	...
	public String getSignTerNo(){
		return this.signTerNo;
	}
	
	public void setSignTerNo(String signTerNo){
		this.signTerNo = signTerNo;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((signTerNo == null) ? 0 : signTerNo.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final SignTerReg other = (SignTerReg) obj;
		if (phoneNum == null) {
		...
		if (affordCardInst == null) {
			...
			return false;
		if (signTerNo == null) {
			if (other.signTerNo != null)
				return false;
		} else if (!signTerNo.equals(other.signTerNo))
			return false;
		return true;
	}
