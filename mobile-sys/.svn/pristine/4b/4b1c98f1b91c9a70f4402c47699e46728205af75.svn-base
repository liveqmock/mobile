...
public class AccInfData extends BaseDataController{
	...
	public DataModelAndView getAccInf(
    		...
    		@RequestParam("bankcardNum") String bankcardNum){
		return new DataModelAndView(accInfManager.getAccInf(bankcardNum));
	}
	...
	public DataModelAndView removeAccInf(
    		...
    		HttpServletResponse response,
    		@RequestParam("bankcardNum") String bankcardNum){
		accInfManager.removeAccInf(bankcardNum);
	...
	public DataModelAndView removeAccInfs(
    		HttpServletRequest request,
    		HttpServletResponse response){
		accInfManager.removeAccInfs(request.getParameterValues("bankcardNum"));
