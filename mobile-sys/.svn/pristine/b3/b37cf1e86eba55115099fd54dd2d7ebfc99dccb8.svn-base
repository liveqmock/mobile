...
import com.gsoft.mobile.core.service.SignTerRegManager;
/**
 * @author 
 *
 */
...
public class SignTerRegData extends BaseDataController{
	...
	public DataModelAndView getSignTerReg(
		...
		return new DataModelAndView(signTerRegManager.getSignTerReg(clientId));
	}
	...
	public DataModelAndView removeSignTerReg(
    		...
    		HttpServletResponse response,
    		@RequestParam("clientId") String clientId){
		signTerRegManager.removeSignTerReg(clientId);
	...
	public DataModelAndView removeSignTerRegs(
    		HttpServletRequest request,
    		HttpServletResponse response){
		signTerRegManager.removeSignTerRegs(request.getParameterValues("clientId"));
