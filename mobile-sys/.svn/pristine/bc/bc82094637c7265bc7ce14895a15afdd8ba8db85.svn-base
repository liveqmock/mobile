...
public class CommInfData extends BaseDataController{
	...
	public DataModelAndView getCommInf(
    		...
    		@RequestParam("commodityNo") String commodityNo){
		return new DataModelAndView(commInfManager.getCommInf(commodityNo));
	}
	...
	public DataModelAndView removeCommInf(
    		...
    		HttpServletResponse response,
    		@RequestParam("commodityNo") String commodityNo){
		commInfManager.removeCommInf(commodityNo);
	...
	public DataModelAndView removeCommInfs(
    		HttpServletRequest request,
    		HttpServletResponse response){
		commInfManager.removeCommInfs(request.getParameterValues("commodityNo"));
