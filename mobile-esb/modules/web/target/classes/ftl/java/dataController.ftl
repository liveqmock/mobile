...
public class ${modelClassName}Data extends BaseDataController{
	...
	public DataModelAndView get${modelClassName}(
    		...
    		@RequestParam("${idAttribute.name}") String ${idAttribute.name}){
		return new DataModelAndView(${modelName}Manager.get${modelClassName}(${idAttribute.name}));
	}
	...
	public DataModelAndView remove${modelClassName}(
    		...
    		HttpServletResponse response,
    		@RequestParam("${idAttribute.name}") String ${idAttribute.name}){
		${modelName}Manager.remove${modelClassName}(${idAttribute.name});
	...
	public DataModelAndView remove${modelClassName}s(
    		HttpServletRequest request,
    		HttpServletResponse response){
		${modelName}Manager.remove${modelClassName}s(request.getParameterValues("${idAttribute.name}"));
